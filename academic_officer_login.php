...
if (!isset($_SESSION["ac"])) {// checking if there are details in session
...
?>
    ...
    <body style="background-color: rgb(220,220,220);">
        ...
        if (isset($_COOKIE["eac"])) {//check theres a cookie named "eac"
            $eac = $_COOKIE["eac"];//if it hase cookie named "eac" then assign it to global variable $tt
        }

        if (isset($_COOKIE["pac"])) {//check theres a cookie named "pac"
            $pac = $_COOKIE["pac"];//if it hase cookie named "pac" then assign it to global variable $ttp
        }
        ?>
        ...
        <div class="card mb-3 " style="border-radius: 6px; max-width: 75%;margin-left:auto;margin-right:auto;margin-top:100px;">
            <div class="row g-0">
                ...
                <div class="col-md-7" style="display:block;" id="login">
                    <div class="card-body">
                        <h5 class="card-title " style="font-weight:bold;font-size:22px">Academic officer Login</h5>
                        <!--form-->

                        <div class="mb-3 " style="margin-top: 40px;">
                            <label for="exampleInputEmail1" class="form-label">Username</label>
                            <!-- if when its clicked remember me on login previously, then add the username taking from the cookie  -->
                            <input type="email" class="form-control" id="u1" value="<?php echo $eac; ?>" aria-describedby="emailHelp">

                        </div>
                        <div class="mb-3">
                            <label for="exampleInputPassword1" class="form-label">Password</label>
                            <!-- if when its clicked remember me on login previously, then add the password taking from the cookie  -->
                            <input type="password" class="form-control" value="<?php echo $pac; ?>" id="p1">
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="row">
                                    <div class="col-3">
                                        <div class="spinner-border " id="spinner" style="display:none;color:red;width: 1.5rem; height: 1.5rem;margin-left:90px" role="status"></div>
                                    </div>
                                    <div class="col-9">
                        ...
                        <button class="button" onclick="login();" style="margin-top: 20px;"><span>Login </span></button>
                        <a onclick="changesignup();" style="text-decoration:none;color:grey; cursor:pointer" class="ms-1">New Academic officer?</a>
                        <!--form-->
                    </div>
                </div>
                <!-- login -->
                ...
                <div class="col-md-7" style="display:none;" id="signup">
                    ...
                    <div class="card-body">
                        <h5 class="card-title " style="font-weight:bold;font-size:22px">Academic officer Sign up</h5>
                        <!--form-->
                ...
                <!-- img -->
                <div class="col-md-5">
                    <img src="images/login/acOfficer.jpg" class="img-fluid rounded-start" alt="...">
                </div>
            </div>
        </div>
        <!--card-->
